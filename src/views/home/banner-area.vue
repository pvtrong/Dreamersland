<template>
  <!-- banner-area done -->
  <section class="banner__area banner__padding relative z-[1] p-[310px_0_295px]
        xl:p-[260px_0_220px]
        lg:p-[260px_0_220px]
        md:p-[260px_0_220px]
        sm:min-h-screen sm:flex sm:items-center sm:p-[180px_0_150px]
        xsm:min-h-screen xsm:flex xsm:items-center xsm:p-[180px_0_150px]
        ">
    <div data-speed="0.2" ref="homeBanner"
      class="banner__bg tg-jarallax absolute w-full h-full bg-center bg-cover z-[-1] left-0 top-0"></div>
...
export default {
  name: 'BannerArea',
  mounted() {
    jarallax(this.$refs.homeBanner, {
      speed: 0.2,
    });
  },
  beforeDestroy() {
    jarallax(this.$refs.homeBanner, 'destroy');
  }
}
</script>
