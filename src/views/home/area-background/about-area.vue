      ...
      <div class="flex flex-wrap mx-[-15px] justify-center items-center">
        <div
          ...
          <div
            ...
            <img src="@/assets/img/others/fun_fact.png"
        ...
        <div
          ...
          <div
            ...
            <h3 class="title text-[45px] font-extrabold tracking-[1px] m-0 leading-[1.15] sm:text-[35px] xsm:text-[35px]">
              The Journey of The <br class="md:hidden sm:hidden xsm:hidden" />
              NFT Sites
            </h3>
          </div>
          ...
          <div
            ...
            <div
              ...
              <img class="pointer-events-none" src="@/assets/img/icons/circle.svg" alt="img" />
              <svg
                ...
                <path class="fill-none" id="textPath" d="M 0,75 a 75,75 0 1,1 0,1 z"></path>
                <text class="fill-[#fff] uppercase text-[22px] font-semibold tracking-[3px]">
              ...
              <div class="about__funFact-lists flex items-center flex-wrap gap-[30px_50px]">
                <div class="about__funFact-item">
                  <h2 class="count flex items-center text-3xl font-semibold leading-none mt-0 mb-2 mx-0">
                    <span ref="odometer1" class="odometer">{{
                      odometerValue1
                    }}</span>
                ...
                <div class="about__funFact-item">
                  <h2 class="count flex items-center text-3xl font-semibold leading-none mt-0 mb-2 mx-0">
                    <span ref="odometer2" class="odometer">{{
                      odometerValue2
                    }}</span>
                    <span class="formatting-mark block leading-none ml-[3px]">K</span>
                  </h2>
                ...
                <div class="about__funFact-item">
                  <h2 class="count flex items-center text-3xl font-semibold leading-none mt-0 mb-2 mx-0">
                    <span ref="odometer3" class="odometer">{{
                      odometerValue3
                    }}</span>
                    <span class="formatting-mark block leading-none ml-[3px]">K</span>
                  </h2>
              ...
              <div class="about__content-btns flex items-center gap-[20px_30px] mt-10 mb-0 mx-0">
                ...
                <a href="https://www.youtube.com/watch?v=ssrNcwxALS4"
                  class="popup-video flex items-center gap-[0_14px] text-[13px] font-semibold text-[#fff] tracking-[0.3px] hover:text-[#45f882] group"><i
                    class="fas fa-play w-[46px] h-[46px] flex items-center justify-center flex-[0_0_auto] border-[#fff] text-[#45f882] text-[14px] transition-all duration-[0.3s] ease-[ease-out] delay-[0s] rounded-[50%] border-2 border-solid group-hover:!text-[#201f2a] group-hover:!border-[#45f882] group-hover:!bg-[#45f882]"></i><span
                    class="text">How It Work</span></a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    waypointHandler({ going, direction }) {
      if (
        (going === 'in' && direction === 'top') ||
        (going === 'out' && direction === 'down')
      ) {
