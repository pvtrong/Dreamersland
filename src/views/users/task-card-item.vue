<template>
  <div class="w-[3/12] basis-[3/12] relative">
    ...
    >
      ...
      <svg
        class="price-bg absolute w-[166px] h-14 text-[#45f882] z-[-1] pointer-events-none left-0 top-0"
        viewBox="0 0 166 56"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      >
        <i class="fas fa-trophy text-[18px] tracking-[0]" />
        <span>{{ bloodCount }}</span>
      </div>
      <div class="tournament__box-countdown mt-0 mb-[46px] mx-0">
        <div
          class="coming-time flex justify-end gap-[15px] leading-none text-center"
          data-countdown="2023/5/16"
        />
      </div>

      <div class="tournament__box-caption text-center mt-0 mx-0">
        <span
          class="sub block text-[16px] leading-none text-[#fff] tracking-[1px] mt-0 mb-[5px] mx-0 font-Barlow"
        >NHIỆM VỤ</span>
        <h4
          class="title text-2xl text-[#45f882] tracking-[1px] m-0 font-medium"
        >
          {{ taskName }}
        </h4>
      </div>
