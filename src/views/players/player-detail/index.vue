<template>
  <main class="main--area overflow-x-hidden">
    <breadcrumb
      ...
      :thumb-image="currentUser.avatar_url || win02Img"
      :isUserDetail="true"
      :createdDate="createdAt"
    />
    <!-- services-area done -->
    <section
      class="services-area services__bg-color pt-[120px] pb-[120px] bg-[#11171D]"
    >
      <div class="container">
        <div class="py-0 xl:px-[60px] xl:py-0 lg:p-0 md:p-0 sm:p-0 xsm:p-0">
          <div
            class="services-row flex flex-wrap items-center align-items-xl-start"
          >
            <div
            ...
            <rank-info
              v-if="currentUser"
              :rankImg="currentUser.rank && currentUser.rank.image_url"
              :currentSeasonPoint="currentUser.current_season_point || 0"
              :currentSeasonBonus="currentUser.current_season_bonus || 0"
              :currentSeasonTotalPoint="
                Number(currentUser.current_season_point || 0) +
          ...
          <div
            class="services-row flex flex-wrap items-center align-items-xl-start mt-28"
          >
            <div
              class="w-6/12 basis-6/12 xl:w-6/12 xl:basis-6/12 lg:w-6/12 lg:basis-6/12 md:w-full md:basis-full sm:w-full sm:basis-full xsm:w-full xsm:basis-full relative"
            >
