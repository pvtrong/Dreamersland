  ...
  <div id="app">
    ...
    <header>
            ...
            <div class="w-full basis-full relative px-[15px]">
              ...
              <div class="tgmenu__wrap">
                ...
                >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <li class="text-left block ml-0 group/second">
                            <a
                              class="font-Barlow text-[15px] leading-[1.4] font-bold text-[#fff] uppercase tracking-[0.8px] relative flex pl-[25px] pr-[15px] py-[9px] before:content-[''] before:block before:h-[7px] before:bg-[#45f882] before:transition-[width] before:duration-[0.2s] before:ease-linear before:ml-0 before:mr-[9px] before:mt-[7px] before:mb-0 before:rounded-[0_5px_0_0] before:w-0 group-hover/second:before:w-[7px]"
                              href="index-2.html"
                              >Home Two</a
                      ...
                      <li class="block relative list-none group">
                        <a
                  ...
                  <div
                    class="tgmenu__action block lg:mr-10 md:mr-10 sm:hidden xsm:hidden"
                  >
                    <ul class="list-wrap m-0 p-0 flex items-center ml-2.5">
                      <li class="search relative ml-0">
                        <a
                          class="block text-[20px] hover:text-[#45f882] text-[#fff]"
                          href="#"
                          ><i class="flaticon-search-1" @click="search"></i
                        ></a>
                      </li>
                      <li
                        class="header-btn relative ml-[25px] pl-[25px] before:content-[''] before:absolute before:-translate-y-2/4 before:w-1.5 before:h-7 before:bg-[#131b22] before:shadow-[inset_0px_3px_7px_0px_rgba(0,0,0,0.61)] before:left-0 before:top-2/4 lg:before:shadow-[inset_0px_3px_7px_0px_#45f882] lg:before:opacity-10 md:before:shadow-[inset_0px_3px_7px_0px_#45f882] md:before:opacity-10 sm:before:shadow-[inset_0px_3px_7px_0px_#45f882] sm:before:opacity-10 xsm:before:shadow-[inset_0px_3px_7px_0px_#45f882] xsm:before:opacity-10"
                      >
                        <a href="contact.html" class="tg-border-btn text-[#fff]"
                          ><i class="flaticon-edit"></i> ~sing in</a
                        >
                      </li>
                      <li
      ...
      >
        ...
        ></div>
        <div
          class="search__close absolute text-3xl text-[#45f882] cursor-pointer right-[5%] top-[5%]"
        >
          <span><i class="flaticon-swords-in-cross-arrangement"></i></span>
        </div>
        <div
          class="search__wrap text-center absolute -translate-y-2/4 top-2/4 inset-x-0"
        >
          <div class="container">
            <div class="flex flex-wrap mx-[-15px]">
              <div class="w-full basis-full relative px-[15px]">
                ...
                >
                  ...
                  <span
                    class="text-[#fff] tracking-[5px] drop-shadow-[-2px_2.5px_0px_rgba(69,248,130,0.66)]"
                    >Search Here</span
                  >
                  ...
                </h2>
                ...
                >
                  <form action="#">
                    <input
                      ...
                      required
                      class="block w-full text-center font-medium text-3xl text-[#fff] pt-2.5 pb-5 px-[50px] border-transparent bg-transparent placeholder:text-3xl placeholder:opacity-50 focus:!ring-[none] focus:!border-transparent"
                    />
                    <button
        ...
        <div class="offCanvas__body flex flex-col flex-1">
          ...
          <div class="offCanvas__content pt-[25px] pb-[50px] px-10">
            ...
            <div class="offCanvas__newsletter">
              ...
              <form
                action="#"
                class="offCanvas__newsletter-form relative mt-0 mb-5 mx-0"
              >
                <input
                  type="email"
                ...
                <button
                  type="submit"
                  class="absolute w-[60px] text-[22px] border-[none] right-0 inset-y-0 bg-transparent before:content-[''] before:absolute before:w-px before:left-0 before:inset-y-1.5 before:bg-[#202b36] group"
                >
                  <i class="flaticon-send group-hover:text-[#ffbe18]"></i>
                </button>
              </form>
              <p class="text-[14px] font-medium m-0">
            ...
            >
              <li class="leading-none">
                <a
                  class="block text-[16px] text-[#fff] hover:text-[#45f882]"
                  href="#"
                  ><i class="fab fa-twitter"></i
                ></a>
              </li>
          ...
          >
            <p
              class="text-[14px] uppercase font-semibold tracking-[1px] m-0 font-Barlow"
            >
              Copyright © 2023 - By
