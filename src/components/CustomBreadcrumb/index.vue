        ...
        <div class="flex flex-wrap">
          <div
            ...
            <div class="breadcrumb__content text-left md:text-center sm:text-center xsm:text-center">
              <h2
                :class="{ ' text-[45px] sm:text-[35px] xsm:text-[35px]  leading-[0.8] mt-0 mb-[21px] mx-0 font-berlin wow fadeInUp sm:mt-0 sm:mb-[21px] sm:mx-0 xsm:text-[14vw] xsm:mt-0 xsm:mb-[21px] xsm:mx-0 text-show-title': true, 'title': isUserDetail }">
                {{ pageTitle }}
              </h2>
              <nav aria-label="breadcrumb">
                <ol
                  ...
                  <li
                    ...
                    <a class="hover:text-[#ffbe18]" @click="handleRedirectHomePage">Home</a>
                  </li>
                  <li
              ...
              <div v-if="isUserDetail"
                class="absolute md:relative sm:relative xsm:relative whitespace-pre mt-9 px-14 py-4 bg-[#EBB917] inline-block text-black font-Barlow font-bold rounded-md">
          ...
          <div
            ...
            <div
              ...
              <div v-if="isUserDetail" class="w-80 h-80">
                <img
                  class="w-full h-full max-h-[412px] max-w-[402px] group-hover:animate-[breadcrumbShake_0.82s_cubic-bezier(0.36,0.07,0.19,0.97)_both] lg:max-h-[260px] lg:max-w-[255px] xl:max-h-80 xl:max-w-[310px]"
                  src="@/assets/img/bg/image-user-detail.svg" alt="img" />

                <img
                  class="absolute w-[8.5rem] h-[8.5rem] lg:w-28 lg:h-28 lg:top-[90px] lg:left-[70px] 2xl:left-[90px] left-[85px] top-[115px] rounded-[50%] max-h-[412px] max-w-[402px] group-hover:animate-[breadcrumbShake_0.82s_cubic-bezier(0.36,0.07,0.19,0.97)_both] lg:max-h-[260px] lg:max-w-[255px] xl:max-h-80 xl:max-w-[310px]"
                  :src="thumbImage" alt="img" />
              </div>
            </div>
          </div>
